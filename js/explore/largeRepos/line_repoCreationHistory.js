...
function draw_line_repoCreationHistory(areaID, repoNamesWOwner) {
  ...
  function drawGraph(data, data2, dataR, dataR2, areaID) {
    ...
    // TODO replace this date with ORNL software founder
    ...
    // Draw line
    chart.append('path').datum(data).attr('class', 'line').attr('d', valueline);
    // Draw line2
    chart.append('path').datum(data2).attr('class', 'second line').attr('d', valueline);
